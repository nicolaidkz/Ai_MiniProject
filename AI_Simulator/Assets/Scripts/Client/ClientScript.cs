...
public class ClientScript : MonoBehaviour
{
    ...
    public string GetPosition()
    {
        ...
        byte[] message = Encoding.ASCII.GetBytes("CollectWood");
    ...
    public void Message_Received(IAsyncResult res)
    {
    ...
    public void ButtonEvent()
    {
        ...
        msgFromFSM = cScript.GetPosition();
        Debug.Log("before split: " + msgFromFSM);
    }
